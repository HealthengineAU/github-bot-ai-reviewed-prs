...
//
// `provider_group_metric` picks what those bands measure: "total" (default,
// additions + deletions) or "additions", which routes delete-heavy PRs to the
// smaller band. It does not affect min_diff_size/max_diff_size eligibility,
// which always measures the total.
//
