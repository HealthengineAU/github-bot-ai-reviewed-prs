...
// Copilot code-review effort levels. GitHub exposes no per-request parameter
// for these — a requested review runs at the org/repo default — so we carry
// the level for display/routing only, and `ai_review.copilot_efforts` declares
// which levels that default makes available. See lib/review-routing.js.
export const EFFORT = {
  Lite: "lite",
  Balanced: "balanced",
};
