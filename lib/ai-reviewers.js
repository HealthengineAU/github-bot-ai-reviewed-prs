...
// the PR's size is known and `ai_review.provider_groups` has a band covering
// it, the pick is restricted to that band's summonable providers; otherwise
// every enabled provider is in the running.
export async function triggerRandomReviewer(octokit, { owner, repo, issue_number, config, diffSize, linesAdded }) {
